    ...
    <div className="min-h-screen bg-black text-white pt-32 pb-24 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-20 p-8 md:p-12 border border-white/10 bg-white text-black relative"
        >
          ...
          <p className="text-2xl md:text-3xl font-bold leading-snug text-black mb-6 max-w-2xl">
          ...
          <div className="flex flex-col gap-4 max-w-2xl">
            <p className="text-sm md:text-base text-black/60 leading-relaxed">
              In algo trading, my backtests looked great in simulation and broke apart in live markets. In DeFi arbitrage, I could see the opportunity but couldn't model the cascade — what happens when you execute, who else reacts, what changes. Every decision I made was downstream of a question I couldn't properly answer.
            </p>
            <p className="text-sm md:text-base text-black/60 leading-relaxed">
              The tools that existed were either single-prompt AI — which hallucinates its way to confidence — or prediction markets, which just price the crowd's existing bias. Neither of these is actually telling you what's likely. One is a guess dressed up as analysis. The other is a popularity contest.
            </p>
            <p className="text-sm md:text-base text-black/60 leading-relaxed">
              I figured out the right way to solve the problem. The answer wasn't a smarter prompt or a better betting pool — it was a fundamentally different approach to how AI should reason about uncertainty. I built Hemlo around that. It's the tool I needed years ago and couldn't find anywhere.
            </p>
          </div>
        </motion.div>
        ...
        >
          ...
          <div className="flex gap-6">
            {[
              { label: "First system built", value: "Age 15" },
              { label: "Products shipped", value: "4+" },
              { label: "Technologies broken into", value: "DeFi, AI, Automation, Finance" },
            ].map(s => (
