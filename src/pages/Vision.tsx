...
import { Network, Database, Brain, Zap, Globe, Shield } from 'lucide-react';
import { SEO } from '../components/SEO';

export default function Vision() {
  return (
    <>
      <SEO title="Vision | HEMLO" description="Read about our vision for Quantitative Intelligence." path="/vision" />
