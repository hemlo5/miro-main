        ...
        <footer className="fixed bottom-0 left-0 flex h-screen w-full flex-col justify-between overflow-hidden bg-background text-foreground cinematic-footer-wrapper">
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-12 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-4 w-full">
              {/* Sign In Card */}
              <div className="w-full max-w-md footer-glass-pill p-6 md:p-8 rounded-3xl flex flex-col items-center gap-4 relative overflow-hidden group">
                ...
                <div className="w-full relative z-10 flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <input 
                      ...
                      className="w-full bg-black/40 border border-white/10 rounded-2xl px-5 py-4 text-white placeholder:text-white/30 focus:outline-none focus:border-white/30 focus:ring-1 focus:ring-white/30 transition-all" 
                    />
                  </div>
                  <MagneticButton as="button" className="w-full bg-white text-black hover:bg-white/90 font-bold py-4 rounded-2xl transition-colors mt-2 text-base flex items-center justify-center gap-2">
                    Sign In / Get Started
